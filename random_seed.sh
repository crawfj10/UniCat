...
#root='vit_rnt_fusion_cat_s128x256'
root='vit_rnt_fusion_cat_s256x128'
out_path='/home/ubuntu/jenni/logs/mm/rgbnt201/hpo/'
ckpt_path='/home/ubuntu/jenni/ckpts/mm/rgbnt201/hpo/'
...
do
	...
	OUTPUT_DIR "${out_path}seed_${seed}/${root}_bs_128_lr_${lr}" \
	CKPT_DIR "${ckpt_path}seed_${seed}/${root}_bs_128_lr_${lr}"
    done
done
